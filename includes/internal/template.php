...
if ( ! class_exists( 'BJN_Template_Loader' ) ) {
	...
	class BJN_Template_Loader {
		 ...
		 * @var string
		 */
		protected $filter_prefix = 'SP451_ELEMENT_EVENTS';
		 ...
		 * @var string
		 */
		protected $plugin_directory = 'includes';
